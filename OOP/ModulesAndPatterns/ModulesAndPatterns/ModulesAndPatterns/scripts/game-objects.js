var GameObjects = (function () {
    ...
    var Apple = (function () {
        ...
        Apple.prototype.draw = function (renderer) {
            renderer.drawCells([this.body], 'red');
        };
    ...
    var Snake = (function () {
        ...
        Snake.prototype.draw = function (renderer) {
            renderer.drawCells([this._head], 'green');
        ...
        Snake.prototype.onKeyDown = function (event) {
            ...
            if (keyCode === 38 && this._direction !== _dirs.down)
                this._direction = _dirs.up;

            if (keyCode === 39 && this._direction !== _dirs.left)
                this._direction = _dirs.right;

            if (keyCode === 40 && this._direction !== _dirs.up)
